...
<div id="main-content-wp" class="cart-page" style="padding-bottom: 200px;">
    ...
    <div id="wrapper" class="wp-inner clearfix">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="clearfix">
                                    <div  class="fl-right">
                                        <a style="margin-right: 660px;background-color: #1fc70c;" href="?modules=checkouts&controllers=index&action=story" title="" id="checkout-cart">Lịch sử đơn hàng</a>
        ...
        <div class="section" id="action-cart-wp">
            <div class="section-detail">
                <p class="title">Click vào <span style="color: green;"><u>Cập nhật giỏ hàng</u></span> để cập nhật số lượng. Nhấn vào <span style="color: blue;"><u>thanh toán</u>
                </span> để hoàn tất mua hàng.</p>
